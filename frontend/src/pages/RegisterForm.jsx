...
const handleSubmit = async (e) => {
            ...
            {[
              ...
              <div className="flex items-center mb-6" key={name}>
                ...
                <input
                  ...
                  value={formData[name]}
                  onChange={handleChange}
                  className="flex-1 p-3 border border-gray-300 rounded-md text-gray-900  bg- focus:outline-none focus:ring-2 focus:ring-blue-500"
                  required
                />
              </div>
            ))}
  ...
  <div className="mt-6 text-l text-black">
    Already have an account?{' '}
    <span
      onClick={() => navigate('/login')}
      className="text-blue-900 underline cursor-pointer hover:text-blue-900"
    >
      Login
    </span>
  </div>
